...
class Clase1(APIView):
    ...
    def post(self, request):
        ...
        # #############################################################################################################################
        # Respaldar este código (recomendación Instructor)
        # try:
        ...
        try:
            ...
            return JsonResponse({"estado":"error", "mensaje":f"La categoria_id informada no existe en la base de datos"}, status=HTTPStatus.BAD_REQUEST)
...
class Clase2(APIView):
    ...
    def put(self, request, id):
        ...
        try:
            data = Receta.objects.filter(pk = id).update(
                nombre=request.data["nombre"],
